...
class music_player_ws_server_application(ws_server.ws_server_application_protocol):
    ...
    async def on_login(
        ...
        self.ws_server_instance.server_instance.get_module_instance('music_player_server').playing_users[content['username']] = {'username': content['username'], 'already_playing': False, 'websocket_protocol': websocket_protocol}
    ...
    async def on_quit(
        ...
        del self.ws_server_instance.server_instance.get_module_instance('music_player_server').playing_users[content['username']]
