...
if __name__ == '__main__': # Main
    ...
    with open('/module_config.json', 'r') as module_config_json_file:
        module_config = json.load(module_config_json_file)
    
    working_load_config = module_config['working_load_config']
    for working_load_item in working_load_config:
        if working_load_item['enabled']:
            ...
            working_loads[working_load_item['id']]['instance'] = getattr(__import__(working_load_item['id'].path), working_load_item['id'])()
