...
if __name__ == '__main__': # Main
    ...
    ws_server = websockets.serve(ws_handler = receive.receive, host = global_matter.SERVER_HOST, port = global_matter.SERVER_PORT, ping_interval = 1, ping_timeout = 1) # Start WS server
